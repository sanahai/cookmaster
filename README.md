...
조리·제과제빵 자격증(한식·양식·중식·일식 조리기능사 + 제과·제빵기능사) 필기시험 **문제은행 학습 플랫폼**.
...
- **웜 오렌지 디자인 시스템** — 요리 브랜드 컬러 팔레트(`tailwind.config.ts`)
...
npx prisma db seed        # 6종 과정 + 샘플 문제 + 데모 계정
...
| 관리자 | admin@cookmaster.kr       | admin1234  |

> 학생 계정은 "한식조리기능사" 과정이 활성 상태로 등록되어 바로 학습할 수 있습니다.
