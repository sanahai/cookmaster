...
export const metadata = {
  title: "회사정보 · 고객센터 · COOKmaster",
  description: "COOKmaster 운영사 회사정보와 고객센터 안내",
};
        ...
        <section className="bg-gradient-to-b from-primary-pale to-beauty-bg">
          <div className="mx-auto max-w-5xl px-4 py-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-beauty-gray">
              데이터 기반 학습과 AI 해설로 조리·제과제빵 국가자격증 필기 합격을 돕는 학습 플랫폼입니다.
            </p>
        ...
        <div className="mx-auto max-w-5xl space-y-8 px-4 py-12">
          ...
          <section id="company" className="scroll-mt-24">
            ...
            <div className="card space-y-4 text-sm leading-relaxed text-beauty-gray">
              <p>
                <strong className="text-beauty-neutral">COOKmaster</strong>는 한식·양식·중식·일식 조리기능사와 제과·제빵기능사
