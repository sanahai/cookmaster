...
export default async function LandingPage() {
  ...
  const reviews = [
    { name: "이○○", course: "한식조리기능사", stars: 5, tag: "3회차 반복으로 정답 암기 탈출", text: "선택지가 매번 섞여서 정답 위치를 외우는 습관이 사라졌어요. 3회차 돌고 나니 진짜 외워졌습니다." },
    { name: "박○○", course: "양식조리기능사", stars: 5, tag: "오답복습으로 시간 단축", text: "오답복습 기능이 최고예요. 틀린 문제만 모아서 다시 푸니 시간이 확 줄었어요. 한 번에 합격!" },
    { name: "최○○", course: "제과기능사", stars: 4, tag: "실전 같은 모의고사", text: "모의고사 난이도가 실제 시험이랑 비슷해서 실전 감각 잡는 데 큰 도움이 됐습니다." },
    { name: "정○○", course: "제빵기능사", stars: 5, tag: "출퇴근 자투리 시간 합격", text: "직장 다니면서 출퇴근 시간에 폰으로 풀었어요. 짧게 자주 푸는 구조라 부담 없이 합격했습니다." },
    { name: "김○○", course: "중식조리기능사", stars: 3, tag: "AI 해설로 책 없이 끝", text: "해설이 자세해서 따로 책을 볼 필요가 없었어요. 틀린 이유를 바로 이해하니 같은 실수를 안 하게 됐습니다." },
    { name: "한○○", course: "일식조리기능사", stars: 5, tag: "모의고사 6회로 84점 합격", text: "모의고사 6회를 다 풀고 나니 실제 시험이 오히려 쉽게 느껴졌어요. 84점으로 합격했습니다!" },
    { name: "윤○○", course: "제과기능사", stars: 5, tag: "단계별 잠금으로 길 안 잃음", text: "단계별로 잠금이 풀려서 뭘 해야 할지 헷갈리지 않았어요. 시키는 대로만 했더니 합격이네요." },
    { name: "장○○", course: "한식조리기능사", stars: 5, tag: "2회 탈락 후 3주 만에 합격", text: "두 번 떨어졌다가 여기서 3주 공부하고 붙었어요. 반복학습 알고리즘이 진짜 효과 있습니다." },
  ];
  ...
  const faqs = [
    ...
    {
      q: "환불은 가능한가요?",
      a: "학습 이력이 없는 경우 결제일로부터 7일 이내 전액 환불이 가능합니다. 자세한 사항은 support@cookmaster.kr로 문의해 주세요.",
    },
  ];
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-primary-pale to-beauty-bg">
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
            ...
            <div className="absolute bottom-0 left-1/3 h-56 w-56 animate-pulse rounded-full bg-orange-300/20 blur-3xl [animation-delay:2s]" />
          </div>
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:py-20 lg:grid-cols-2">
            <div className="text-center lg:text-left">
              ...
              <p className="mb-9 max-w-2xl text-lg text-beauty-gray lg:mx-0">
                ...
                한식·양식·중식·일식 조리기능사와 제과·제빵기능사까지 6종 자격증, AI가 만들어낸
                방대한 문제은행으로 필기시험에 합격하세요.
              </p>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="card text-center">
              <h3 className="text-lg font-bold text-beauty-neutral">조리기능사 패키지</h3>
