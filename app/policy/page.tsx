...
export const metadata = {
  title: "이용약관 · 개인정보처리방침 · 환불정책 · COOKmaster",
  description: "COOKmaster 이용약관, 개인정보처리방침, 환불정책 안내",
};
          ...
          <div className="space-y-12">
            ...
            <div className="card text-sm leading-relaxed text-beauty-gray">
              ...
              <p>
                ...
                <br />
                서비스명: COOKmaster · 고객센터:{" "}
                <a href="mailto:support@cookmaster.kr" className="font-semibold text-primary">
                  support@cookmaster.kr
                </a>
              </p>
            </div>
            ...
            <section id="terms" className="scroll-mt-24">
              ...
              <div className="card space-y-5 text-sm leading-relaxed text-beauty-gray">
                <Clause title="제1조 (목적)">
                  <p>
                    이 약관은 골든웨이브(이하 “회사”)가 운영하는 COOKmaster(이하 “서비스”)의
                ...
                <Clause title="제2조 (정의)">
                  <p>1. “서비스”란 회사가 제공하는 조리·제과제빵 자격증 필기시험 대비 온라인 문제은행 및 관련 학습 콘텐츠 일체를 말합니다.</p>
                ...
                <Clause title="제4조 (서비스의 내용)">
                  <p>1. 회사가 제공하는 서비스는 한식·양식·중식·일식 조리기능사 및 제과·제빵기능사 자격증 필기시험 대비를 위한 학습용 문제은행 및 모의고사, 오답복습 등 부가 학습 기능입니다.</p>
                  <p>
              ...
              <div className="card space-y-5 text-sm leading-relaxed text-beauty-gray">
                <Clause title="제1조 (목적)">
                  <p>
                    ...
                    관련 법령에 따라 COOKmaster 유료 콘텐츠의 청약철회 및 환불 기준을 정함을 목적으로
                    합니다.
                  </p>
                </Clause>
