        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          {mode === "paid" && (
            <InfoBlock
              icon="💳"
              title="환불 안내"
              body="결제 후 학습 기록(문제 풀이)이 전혀 없는 경우, 결제일로부터 7일 이내 전액 환불이 가능합니다. 다만 단 1문항이라도 풀이를 시작하면 디지털콘텐츠 제공이 개시된 것으로 보아 환불이 제한될 수 있습니다. 결제 전 무료체험 100문제로 충분히 확인하시기를 권장합니다. (문의: support@cookmaster.kr)"
              highlight
            />
          )}
              ...
              {items.map((it) => (
                ...
                >
                  <input
                    ...
                    className="mt-0.5 h-5 w-5 shrink-0 rounded border-gray-300 text-orange-600 focus:ring-orange-500"
                  />
