...
export function AIExplanationSection() {
  const examples = [
    ...
    {
      subject: "중식조리기능사 · 중식조리실무",
      question: "중국 요리에서 '炒(chǎo)'에 해당하는 조리법은?",
      picked: "③ 찜(steaming)",
      answer: "① 볶음(stir-frying)",
      diagnosis:
        "찜은 수증기 조리법입니다. 炒(볶음)은 강불에서 팬을 흔들며 재료를 빠르게 익히는 중식의 대표 조리법으로, 채소·고기 요리의 핵심 기법입니다.",
    },
    {
      subject: "일식조리기능사 · 일식조리실무",
      question: "일식 다시(出汁)의 기본 재료로 옳지 않은 것은?",
      picked: "② 가쓰오부시",
      answer: "④ 고춧가루",
      diagnosis:
        "가쓰오부시(멸치)는 일식 다시의 핵심 재료입니다. 다시는 다시마·가쓰오부시·시오다시 등으로 우려내며, 고춧가루는 한·중식 양념에 쓰이는 재료입니다.",
    },
    {
      subject: "제과기능사 · 재료과학",
